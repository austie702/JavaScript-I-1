...
console.log();
console.log('* * * Arrays Block -- START * * *');
let yearLookup = '';
let makeLookup = '';
let modelLookup = '';
for (let i = 0; i < inventory.length; i++) {
  if (inventory[i].id === 33) {
    yearLookup = inventory[i].car_year;
    makeLookup = inventory[i].car_make; 
    modelLookup = inventory[i].car_model;
  }
}
console.log(`Car 33 is a ${yearLookup} ${makeLookup} ${modelLookup}` );
